...
class Telnet_function:
 ...
 def register_switch(self,values):
  ...
  self.tbentries_dict['switch_access'].remove('id')
  required_count = len(self.tbentries_dict['switch'])+len(self.tbentries_dict['switch_property'])+len(self.tbentries_dict['switch_access'])+1
  ...
  if valid_values:
   ...
   require_msgs={0:" 1. What is the switch name? :",
                 ...
                 8:" 9. What is the account to access? :",
                 9:"10. What is the password to access? :",
                10:"11. What is the enable password to access? :"}
   input_values=[]
